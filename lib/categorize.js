...
const CATEGORY_MAP = {
  ...
  video: ['mp4', 'mkv', 'avi', 'mov', 'wmv', 'flv', 'webm', 'm4v', 'mpg', 'mpeg', '3gp', 'ts', 'vob', 'ogv'],
...
function knownCategories() {
  return [...Object.keys(CATEGORY_MAP), OTHERS];
}

module.exports = { categorizeByExtension, knownCategories, getExtension, OTHERS, CATEGORY_MAP };
